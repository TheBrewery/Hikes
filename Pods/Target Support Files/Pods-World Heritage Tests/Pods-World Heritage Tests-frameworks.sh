...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-World Heritage Tests/Alamofire.framework"
  install_framework "Pods-World Heritage Tests/AlamofireImage.framework"
  install_framework "Pods-World Heritage Tests/FBAnnotationClusteringSwift.framework"
