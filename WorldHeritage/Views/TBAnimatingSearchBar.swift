...
//        }
    ...
    override init(frame: CGRect) {
        ...
        backgroundView.addTarget(self, action: #selector(TBAnimatingSearchBar.didTap), forControlEvents: .TouchUpInside)
        ...
        cancelButton.addTarget(self, action: #selector(TBAnimatingSearchBar.didTapCancelButton), forControlEvents: .TouchUpInside)
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(TBAnimatingSearchBar.textFieldTextDidChange(_:)), name: UITextFieldTextDidChangeNotification, object: nil)
    }
